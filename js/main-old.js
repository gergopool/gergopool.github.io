...
function initProjectModals() {
    ...
    const projectDetails = {
        'prisma': {
            title: 'Prisma',
            description: 'Extracting psychological data, resilience, and player communication statistics from esports footage for further analysis.',
            responsibilities: [
                'Process speech data, extract psychological data, resilience, and player communication statistics from esports footage for further analysis',
                'Construct a database of historical esports footage and associated statistics',
            ...
            details: 'This project involves analyzing esports footage to extract valuable insights about player psychology, resilience under pressure, and communication patterns. The data is processed using advanced NLP and computer vision techniques to provide actionable insights for esports teams and coaches.'
        },
        'bash-agent': {
